...
export class MedalTimes {
  ...
  async get(
    ...
    const result = await this.db.pool.query(
      `
        select MedalTimes.*, Players.Name as Players_Name, Players.DateModified as Players_DateModified, Players.Color as Players_Color, Maps.AuthorTime, Maps.Name as Maps_Name, Maps.Campaign, Maps.CampaignIndex, Maps.TotdDate, Maps.Nadeo, Maps.DateModified as Maps_DateModified from MedalTimes
